...
export default class Expenses extends Component {
  ...
  handleSave = () => {
    ...
    if (
      flag &&
      (AuthenticateFare === null || AuthenticateFare === undefined) &&
      (AssessFare === null || AssessFare === undefined)
    ) {
      data = {
        expert: store.getState().ExpertID,
        id: selectedNode.CID,
      ...
      data = {
        ...
        id: selectedNode.CID,
        AuthenticateFare:
          AuthenticateFare === null ? undefined : AuthenticateFare,
              ...
              >
                ...
                <Form.Item name="AuthenticateFare" label="鉴定服务定价/单件">
                  <InputNumber
                    ...
                    step="1.00"
                    style={{ width: '200px' }}
                    onChange={(e) => this.setState({ AuthenticateFare: e })}
                  />
                </Form.Item>
                <Form.Item name="AssessFare" label="估价服务定价/单件">
                  <InputNumber
                    ...
                    step="1.00"
                    style={{ width: '200px' }}
                    onChange={(e) => this.setState({ AssessFare: e })}
                  />
                </Form.Item>
              </Form>
            </Content>
