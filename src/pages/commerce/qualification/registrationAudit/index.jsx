      ...
      <div>
        ...
        >
          <Form layout="vertical" ref={this.formRef} hideRequiredMark>
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name="IsBranch" label="是否为分行">
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name="FoundDate" label="成立时间">
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name="PermitCode" label="经营许可证编码">
                  <Input disabled />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name="PermitDate" label="许可证发证日期">
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name="PermitAuthority" label="许可证批准机关">
                  <Input disabled />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name="BLicenseAuthority" label="营业执照登记机关">
                  <Input disabled />
                </Form.Item>
              </Col>
            </Row>
