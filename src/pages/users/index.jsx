          ...
          >
            <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
              ...
              <SubMenu key="sub2" icon={<ShopOutlined />} title="在线商城">
                <Menu.Item key="5">
                  <MyNavLink replace to={`onlineshop`}>
                    绝当品信息
                  </MyNavLink>
                </Menu.Item>
              </SubMenu>
              <SubMenu key="sub3" icon={<FormOutlined />} title="信息管理">
                ...
                <Menu.Item key="7">
                  <MyNavLink replace to={`infomanage/pawnshopinfo`}>
                    当行信息查询
                  </MyNavLink>
                </Menu.Item>
                <Menu.Item key="8">
                  <MyNavLink replace to={`infomanage/pawnticket`}>
                    当单信息查看
                  </MyNavLink>
                </Menu.Item>
                <Menu.Item key="9">
                  <MyNavLink replace to={`infomanage/orderinfo`}>
                    订单信息查看
                  </MyNavLink>
                </Menu.Item>
              </SubMenu>
              <SubMenu key="sub4" icon={<SoundOutlined />} title="反馈投诉">
                <Menu.Item key="12">
                  <MyNavLink replace to={`feedback/fbtpawnshop`}>
                    反馈典当行
                  </MyNavLink>
                </Menu.Item>
                <Menu.Item key="13">
                  <MyNavLink replace to={`feedback/fbtocommerce`}>
                    反馈商务部
                  </MyNavLink>
                </Menu.Item>
              </SubMenu>
            ...
            <Content style={{ margin: '10px 16px' }}>
              ...
              >
                <Routes>
                  ...
                  />
                  <Route
                    path="infomanage/pawnshopinfo"
                    element={<PawnshopInfo />}
                  />
                  <Route
                    path="infomanage/pawnticket"
                    element={<Pawnticket />}
                  />
                  <Route path="infomanage/orderinfo" element={<OrderInfo />} />
                  <Route
                    path="feedback/fbtpawnshop"
                    element={<FbToPawnshop />}
                  />
                  <Route
                    path="feedback/fbtocommerce"
                    element={<FbToCommerce />}
                  />
                </Routes>
              </div>
            </Content>
