        ...
        <div className="site-layout-background" style={{ padding: 10, height: '80vh'}}>
          <Layout style={{ height: '70vh' }}>
              ...
              <Content style={{ paddingLeft: 10, backgroundColor: 'white' }}>
                <div>
                  <Button type="primary" onClick={()=>{this.handleAdd('son')}} icon={<PlusOutlined />} style={{marginBottom: 10, marginLeft: 10}}>
                    新增子类目
                  </Button>
                  <Button type="primary" onClick={()=>{this.handleAdd('brother')}} icon={<PlusOutlined />} style={{marginBottom: 10, marginLeft: 10}}>
                    新增同层级类目
                  </Button>
                  <Button type="primary" onClick={this.handleDelete} icon={<CloseOutlined />} style={{marginBottom: 10, marginLeft: 10}}>
                    删除
                  </Button>
