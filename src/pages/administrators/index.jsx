    ...
    <Layout>
      <Header className="header">
        ...
        <Button
          ...
          onClick={() => {
            store.dispatch(createAdministratorAction({}));
        ...
        <Sider collapsible collapsed={state.collapsed} onCollapse={onCollapse}>
          <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
            <SubMenu key="sub1" icon={<SettingOutlined />} title="系统设置">
              ...
              <Menu.Item key="2">
                <MyNavLink replace to={`system/pawndetails`}>
                  典当类目设置
                </MyNavLink>
              </Menu.Item>
            </SubMenu>
            <SubMenu key="sub2" icon={<FormOutlined />} title="信息管理">
              <Menu.Item key="3">
                <MyNavLink replace to={`infomanage/commercemember`}>
                  商务部人员管理
                </MyNavLink>
              </Menu.Item>
              <Menu.Item key="4">
              ...
              <Menu.Item key="5">
                <MyNavLink replace to={`infomanage/userinfo`}>
                  用户信息管理
                </MyNavLink>
              </Menu.Item>
              <Menu.Item key="6">
        ...
        <Layout className="site-layout">
          <Content style={{ margin: '10px 16px' }}>
            <div style={{ padding: 10, height: '83vh' }}>
              <Routes>
                <Route
                  path="system/assessstandard"
                  element={<AssessStandard />}
                />
                <Route path="system/pawndetails" element={<PawnDetails />} />
                <Route
                  path="infomanage/commercemember"
                  element={<CommerceMember />}
                />
                <Route
