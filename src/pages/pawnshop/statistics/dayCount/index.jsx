...
import { Breadcrumb, Calendar, Badge, Input, Button, Form, Tabs, notification, Modal, Tag, Cascader, Upload, message } from 'antd'
...
export default class DayCount extends Component {
  ...
  dateCellRender = (value) => {
    ...
    return (
      <ul className="events">
        {listData.num1&&listData.num1!=0?<li>新建单数：{listData.num1}</li>:''}
        {listData.num2&&listData.num2!=0?<li>完结单数：{listData.num2}</li>:''}
        {listData.outAmount&&listData.outAmount!=0?<li>发放￥{listData.outAmount}</li>:''}
        {listData.inAmount&&listData.inAmount!=0?<li>收回￥{listData.inAmount}</li>:''}
