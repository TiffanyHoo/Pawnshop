...
export default class Charts1 extends PureComponent {
    ...
    return (
      <div style={{width:'100%',height:'100%'}}>
        <Breadcrumb style={{ margin: '10px 0' }}>
          ...
          <Breadcrumb.Item>当单统计</Breadcrumb.Item>
        </Breadcrumb>
        ...
        <ResponsiveContainer width="100%" height="88%">
          ...
          >
            ...
            <Tooltip />
            <Legend />
            <Bar yAxisId="left" dataKey="num1" stackId="a"name="新建当单" fill="#8884d8" />
            <Bar yAxisId="left" dataKey="num2" stackId="a" name="完结当单" fill="#82ca9d" />
