                ...
                return {
                    onDoubleClick: event => {
                        ...
                        setTimeout(() => {
                            if(ApplyType=='1'){
                                this.formRef.current.setFieldsValue({
                                    ApplyID,ApplyType:'建当',UserID,UserName,Address,Phone,Email,Wechat,Plandate,ApplyDate,Gender:Gender==='1'?'女':'男',
                                    Amount,ANotes
                                })
                                this.getThings1(TID)
                            }else{
                                this.formRef2.current.setFieldsValue({
                                    PTID,ApplyID,ApplyType:ApplyType==='2'?'续当':ApplyType==='3'?'赎当':'绝当',UserID,UserName,Address,Phone,Email,Wechat,Plandate,ApplyDate,Gender:Gender==='1'?'女':'男',
                                    Amount,ANotes
                                })
