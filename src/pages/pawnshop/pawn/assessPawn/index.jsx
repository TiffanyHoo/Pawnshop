...
export default class AssessPawn extends Component {
  ...
  selectTreeNode = async (treeNode) => {
    ...
    this.setState({
      ...
      flag,
      PawnDue,
      InterestRatio: InterestRatio ? InterestRatio : 0,
      StoreCost,
      OverdueCost,
      OtherCost,
    });
                  ...
                  <Col span={10}>
                    <Form.Item name="Rate" label="估价折价率">
                      <InputNumber
                        ...
                        step="0.01"
                        style={{ width: '200px' }}
                        onChange={(e) => this.setState({ Rate: e })}
                      />
                    </Form.Item>
                  </Col>
                  <Col span={10}>
                    <Form.Item name="PawnDue" label="典当周期">
                      <InputNumber
                        ...
                        step="1"
                        style={{ width: '200px' }}
                        onChange={(e) => this.setState({ PawnDue: e })}
                      />
                    </Form.Item>
                  </Col>
                </Row>
                  ...
                  <Col span={10}>
                    <Form.Item name="InterestRatio" label="利 息 比 率">
                      <InputNumber
                        ...
                        step="0.01"
                        style={{ width: '200px' }}
                        onChange={(e) => this.setState({ InterestRatio: e })}
                      />
                    </Form.Item>
                  </Col>
                  <Col span={10}>
                    <Form.Item name="StoreCost" label="仓管费用">
                      <InputNumber
                        ...
                        step="1.00"
                        style={{ width: '200px' }}
                        onChange={(e) => this.setState({ StoreCost: e })}
                      />
                    </Form.Item>
                  </Col>
                </Row>
                  ...
                  <Col span={10}>
                    <Form.Item name="OverdueCost" label="逾 期 费 用">
                      <InputNumber
                        ...
                        step="1.00"
                        style={{ width: '200px' }}
                        onChange={(e) => this.setState({ OverdueCost: e })}
                      />
                    </Form.Item>
                  </Col>
                  <Col span={10}>
                    <Form.Item name="OtherCost" label="其他费用">
                      <InputNumber
                        ...
                        step="1.00"
                        style={{ width: '200px' }}
                        onChange={(e) => this.setState({ OtherCost: e })}
                      />
                    </Form.Item>
                  </Col>
                </Row>
