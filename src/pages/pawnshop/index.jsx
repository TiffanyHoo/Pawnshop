    ...
    return (
        <Layout>
            <Header className="header">
                ...
                <p style={{float:'right',color:'white',marginRight:50}}>操作人员： {JSON.parse(sessionStorage.getItem("userinfo")).PSstaffName}</p>
            </Header>
            {console.log(state)}
            ...
            <Layout>
                <Sider collapsible collapsed={state.collapsed} onCollapse={onCollapse}>
                    <Menu theme="dark" defaultSelectedKeys={['0']} mode="inline">
                        ...
                        <SubMenu key="sub2" icon={<SnippetsOutlined />} title="信息管理">
                            <Menu.Item key="5">
                                <MyNavLink replace to={`info/manageitem`}>当物信息管理</MyNavLink>
                            </Menu.Item>
                            <Menu.Item key="6">
                                <MyNavLink replace to={`info/managepawn`}>当单信息管理</MyNavLink>
                            </Menu.Item>
                            <Menu.Item key="7">
                                <MyNavLink replace to={`info/assesspawn`}>折价率与收费设置</MyNavLink>
                            </Menu.Item>
                        </SubMenu>
                        <SubMenu key="sub3" icon={<ShopOutlined />} title="当物商城">
                            ...
                            <Menu.Item key="10">
                                <MyNavLink replace to={`sales/manageSales`}>订单信息管理</MyNavLink>
                            </Menu.Item>
                        </SubMenu>
                        ...
                        <SubMenu key="sub6" icon={<PieChartOutlined />} title="经营统计">
                            <Menu.Item key="15">
                                <MyNavLink replace to={`statistics/daycount`}>日历结算</MyNavLink>
                            </Menu.Item>
                            {/* <Menu.Item key="15">
                            ...
                            <Menu.Item key="16">
                                <MyNavLink replace to={`statistics/charts1`}>当单统计</MyNavLink>
                            </Menu.Item>
                            <Menu.Item key="17">
                                <MyNavLink replace to={`statistics/charts2`}>金额统计</MyNavLink>
                            </Menu.Item>
                        </SubMenu>
                        ...
                        <SubMenu key="sub8" icon={<SoundOutlined />} title="反馈处理">
                            ...
                            <Menu.Item key="20">
                                <MyNavLink replace to={`feedback/feedbackofsale`}>商城反馈处理</MyNavLink>
                            </Menu.Item>
                        </SubMenu>
                    </Menu>
                </Sider>
                <Layout className="site-layout">
                    <Content style={{ margin: '10px 16px' }}>
                        <div className="site-layout-background" style={{ padding: 10, height: '83vh' }}>
                            <Routes>
                                ...
                                <Route path="expertservice/assessresult" element={<AssessResult/>}/>
                    ...
                    <Footer style={{ textAlign: 'center' }}>典当管理信息平台 © 中富达典当行</Footer>
                </Layout>
            </Layout>
            }
        </Layout>
