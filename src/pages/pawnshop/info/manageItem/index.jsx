...
import { Breadcrumb, Layout, Tree, Input, Table, Tabs, Card, Pagination, notification, message, Form, Drawer, Space, Button, Tag, Modal, Upload, Badge } from 'antd'
...
import { DownOutlined, PlusOutlined, SearchOutlined, CheckOutlined } from '@ant-design/icons';
...
export default class ManageItem extends Component {
    ...
    render() {
        const { TreeData , dataSource, dataSource2, items, total, pageno, pagesize } = this.state;
        const { previewVisible,previewImage,previewTitle,fileList,SpeDetailArr,SpecificationArr,DocDetailArr,SpecificationData,selectedTags,PIID,itemName,title,photopath,Unitprice,Quantity,PriceOnSale,canDistribute,state,Discript } = this.state;
        ...
        <div>
            ...
            <div className="site-layout-background" style={{ padding: '10 0' }}>
                <Layout style={{ height: '70vh' }}>
                    <Sider theme='light'  width={200} style={{padding:10, border:'1px solid #eee'}}>
                      <Tree
                        showLine
            ...
            >
              ...
              >
                ...
                <Form.Item
                  ...
                  label="名称"
                >
                  <Input value={itemName}  onChange={(e)=>{this.setState({itemName:e.target.value})}} />
                </Form.Item>
                <Form.Item
                  name="title"
                  label="类别"
