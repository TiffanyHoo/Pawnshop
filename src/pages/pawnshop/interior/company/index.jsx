...
//PSID,PSName,Address,RegCapital,FoundDate,BusinessTerm,Representative,PermitCode,PermitAuthority,PermitDate,BLicenseAuthority,SocCreCode,Phone,Zip,Description,IsBranch,HeadOfficeID,AuditState,InfoChange,ComMemID 
  ...
  getData = async () => {
    ...
    dataSource = dataSource.map((obj,index) => {
      if(obj.PSID === id){
        const {PSID,PSName,Address,RegCapital,FoundDate,BusinessTerm,Representative,PermitCode,PermitAuthority,PermitDate,BLicenseAuthority,SocCreCode,Phone,Zip,Description,IsBranch,HeadOfficeID,AuditState,InfoChange,ComMemID} = obj
        this.setState({
          PSID,PSName,Address,RegCapital,FoundDate,BusinessTerm,Representative,PermitCode,PermitAuthority,PermitDate,BLicenseAuthority,SocCreCode,Phone,Zip,Description,IsBranch,HeadOfficeID,AuditState,InfoChange,ComMemID
        })  
      }
    ...
    if(dataSource.length === 1){
      const {PSID,PSName,Address,RegCapital,FoundDate,BusinessTerm,Representative,PermitCode,PermitAuthority,PermitDate,BLicenseAuthority,SocCreCode,Phone,Zip,Description,IsBranch,HeadOfficeID,AuditState,InfoChange,ComMemID} = dataSource[0]
  ...
  render() {
    const { count,dataSource,PSID,PSName,Address,RegCapital,FoundDate,BusinessTerm,Representative,PermitCode,PermitAuthority,PermitDate,BLicenseAuthority,SocCreCode,Phone,Zip,Description,IsBranch,HeadOfficeID,AuditState,ComMemID } = this.state;
//PSID,PSName,Address,RegCapital,FoundDate,BusinessTerm,Representative,PermitCode,PermitAuthority,PermitDate,BLicenseAuthority,SocCreCode,Phone,Zip,Description,IsBranch,HeadOfficeID,AuditState,InfoChange,ComMemID)VALUES 
    ...
    return (
      <div>
        ...
        <div className="site-layout-background" style={{ padding: 10 }}>
          ...
          <Table
            ...
            onRow={record => {
              return {
                onDoubleClick: event => {
                  const { PSID,PSName,Address,RegCapital,FoundDate,BusinessTerm,Representative,PermitCode,PermitAuthority,PermitDate,BLicenseAuthority,SocCreCode,Phone,Zip,Description,IsBranch,HeadOfficeID,AuditState,ComMemID } = record
                  this.setState({
                    PSID,PSName,Address,RegCapital,FoundDate,BusinessTerm,Representative,PermitCode,PermitAuthority,PermitDate,BLicenseAuthority,SocCreCode,Phone,Zip,Description,IsBranch,HeadOfficeID,AuditState,ComMemID,
                    DrawerTitle: '编辑当行信息',
                    visible: true
                  });
                },
        ...
        :
        <Form layout="vertical" ref={this.formRef2} hideRequiredMark style={{ overflow: 'auto', height: '72vh', padding: '0 8px' }}
        initialValues={{PSID,PSName,Address,RegCapital,FoundDate:moment(FoundDate),BusinessTerm,Representative,PermitCode,PermitAuthority,PermitDate:moment(PermitDate),BLicenseAuthority,SocCreCode,Phone,Zip,Description,IsBranch,HeadOfficeID}}
        >
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item
            ...
            <Row gutter={16}>
              <Col span={24}>
                ...
                >
                  <Input.TextArea rows={2} value={this.state.Address} onChange={this.handleAddress} placeholder="请输入详细地址" />
                </Form.Item>
              </Col>
            </Row>
            <Row gutter={16}>
              ...
              <Col span={12}>
                ...
                >
                  <Input value={this.state.Representative} placeholder="请输入法定代表人" onChange={this.handleRepresentative} />
                </Form.Item>
              </Col>
            </Row>
            <Row gutter={16}>
