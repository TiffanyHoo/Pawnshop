...
export default function Login() {
    ...
    return (
        <div className="login">
            <video id='Video' muted autoPlay="autoPlay" src="./web/video.mp4" loop="loop">
            ...
            <Carousel autoplay>
                ...
                <div>
                    <img src="https://p1.ssl.qhimg.com/dr/270_500_/t010d96112339819b27.png?size=773x593" alt="" />
                </div>
                <div>
                    <img src="http://l.b2b168.com/2020/04/27/15/202004271524206671694.jpg" alt="" />
                </div>
                <div>
                    <img src="http://www.cdsxdd.com/Public/uploadfile/file/2016-06-24/576ca205876bf.jpg" alt="" />
                </div>
            </Carousel>
            </div>
